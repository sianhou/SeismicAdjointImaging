...
int main(int argc, char *argv[]) {
    ...
    if (flag) {
        ...
        if (rankid == 0) {
            printf("\nExamples:   sjmpiaei2d survey=survey.su vp=vp.su recz=recz.su izz=final_vp.su\n");
            sjbasicinformation();
        }
    }
